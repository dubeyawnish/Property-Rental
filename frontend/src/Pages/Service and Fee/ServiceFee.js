...
import Police from  '../../Images/ServiceFee/Police.jpg'
            ...
            <div className='container'>
                ...
                <div className='row mt-5'>
                    ...
                    <div className='col-lg-9 col-md-19 col-sm-12'>
                        ...
                        <h6>Fee<sup>*</sup>:<span>2% of the Sale value + GST (House/apartment)</span></h6>
                        <h6>Fee<sup>*</sup>:<span>4% of the Sale value + GST (land/Plot)</span></h6>
                        <hr className='mt-2' />
                ...
                <div className='row mt-5'>
                    ...
                    <div className='col-lg-9 col-md-19 col-sm-12'>
                        <h3>Police Verification of Foreign Nationals</h3>
                        <p className='mt-3'>It is mandatory for home owners to intimate the nearest police station if they have rented their property to a foreign national. We offer assistance with completing the entire process</p>
                        <h6>Fee<sup>*</sup>:<span>Rs. 10,000/- + GST </span></h6>
